...
def log(value, status='INFO', color='[K]'):
...
def log_replace(value, status='INFO', color='[K]'):
...
def main():
    print(colors('\n'.join([
    (Sundanis),
        '[T]Domain Fronting [Sidik Software Version 1.3.190427]',
        '[T](c) 2019 Sidik Software inc.', 
        '[T]Remode By Sidik','[CC]'
    ])))
